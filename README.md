...
Replace your README, then push:

```bash
git add README.md
git commit -m "Fix README: column video layout for GitHub compatibility"
git push origin main
```

Each video will now render full-width on its own row — no tables. Click any video to play it.<div align="center">
